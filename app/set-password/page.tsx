  ...
  return (
    <main className="password-shell">
      <section className="password-card">
        ...
        {pageState === "missing" && <div className="password-state"><span className="password-state-icon">⌛</span><p className="password-eyebrow">ENLACE NO DISPONIBLE</p><h1>Necesitas una invitación válida</h1><p>Abre el enlace más reciente que recibiste por correo. Si ya venció, solicita que te enviemos uno nuevo.</p><Link className="password-secondary" href="/sign-in">Volver al inicio de sesión</Link></div>}
